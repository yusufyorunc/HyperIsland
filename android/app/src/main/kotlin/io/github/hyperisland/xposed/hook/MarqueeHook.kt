...
object MarqueeHook {
    ...
    private val CONTROL_WHITESPACE_REGEX = Regex("[\\n\\r\\t\\u00A0\\u200B\\uFEFF]+")
    private val MULTI_SPACE_REGEX = Regex(" +")

    private fun normalizeText(text: String): String {
        return text
            .replace(CONTROL_WHITESPACE_REGEX, " ")
    ...
    class MarqueeController(
        ...
        private companion object {
            ...
            const val RE_MEASURE_INTERVAL_NANOS = 300_000_000L
        }
        ...
        fun start() {
            ...
            startTimeNanos = 0
            lastMeasureNanos = 0
            maxScrollCache = getRealMaxScroll()
        ...
        override fun doFrame(frameTimeNanos: Long) {
            ...
            if (frameTimeNanos - lastMeasureNanos >= RE_MEASURE_INTERVAL_NANOS) {
                maxScrollCache = getRealMaxScroll()
                lastMeasureNanos = frameTimeNanos
            }
            if (maxScrollCache <= 0) {
                stop()
                return
