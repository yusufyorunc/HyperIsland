...
object DownloadHook {
    ...
    private val PROGRESS_PERCENT_PATTERN = Pattern.compile("(\\d+)%")
    private val TAG_ID_PATTERN = Pattern.compile("(\\d{3,})")
    ...
    private val DOWNLOAD_SUFFIXES = listOf(
        "下载中...",
        "下载中",
        "下载...",
        "下载",
    ...
    private val downloadIdMap = ConcurrentHashMap<Long, String>()
    ...
    private fun isDownloadNotification(title: String, text: String, extras: Bundle): Boolean =
        extras.containsKey("extra_download_id") ||
                ...
                title.contains("正在下载") ||
                title.contains("下载中") ||
                title.contains("downloading", ignoreCase = true) ||
                text.contains("下载中") ||
    ...
    private fun extractProgress(title: String, text: String, extras: Bundle): Int {
        ...
        val m = PROGRESS_PERCENT_PATTERN.matcher(combined)
    ...
    private fun extractIdFromTag(tag: String?): Long {
        ...
        val m = TAG_ID_PATTERN.matcher(tag)
    ...
    private fun extractFileNameFromText(text: String): String {
        ...
        val m = FILE_NAME_PATTERN.matcher(s)
        if (m.find()) {
